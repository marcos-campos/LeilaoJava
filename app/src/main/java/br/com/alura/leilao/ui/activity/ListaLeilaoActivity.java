...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private final AtualizadorDeLeilao atualizadorDeLeilao = new AtualizadorDeLeilao();
    ...
    protected void onResume() {
        super.onResume();
        atualizadorDeLeilao.buscaLeiloes(adapter, client,
                new AtualizadorDeLeilao.ErroCarregarLeilaoListener() {
            @Override
            public void erroAoCarregar(String mensagem) {
                mostrarMensagemFalha();
            }
        });
    }

    public void mostrarMensagemFalha() {
        Toast.makeText(this,
